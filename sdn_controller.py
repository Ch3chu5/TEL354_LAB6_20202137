...
class SDNController:
    ...
    def get_attachment_point(self, mac: str) -> Tuple[Optional[str], Optional[int]]:
        ...
        # Mapeo simulado basado en Topologia.txt
        mac_map = {
            "fa:16:3e:c8:72:46": ("00:00:1a:74:72:3f:ef:44", 3),    # Host conectado a SW3
            "fa:16:3e:8b:21:02": ("00:00:f2:20:f9:45:4c:4e", 3),    # Host conectado a SW2
            "fa:16:3e:3c:24:fc": ("00:00:5e:c7:6e:c6:11:4c", 1),    # Host conectado a SW1
            "fe:16:3e:fa:db:4b": ("00:00:f2:20:f9:45:4c:4e", 3),    # Host conectado a SW2
            "fe:16:3e:15:c5:cc": ("00:00:aa:51:aa:ba:72:41", 5),    # Host conectado a SW5
            "fa:16:3e:6c:a0:7c": ("00:00:5e:c7:6e:c6:11:4c", 3),    # Host conectado a SW1 (H1)
            "fe:16:3e:d1:7f:23": ("00:00:72:e0:80:7e:85:4c", 2),    # Host conectado a SW4
            "fa:16:3e:46:3d:a5": ("00:00:aa:51:aa:ba:72:41", 1),    # Host conectado a SW5
        }
...
def mostrar_menu_importar():
    print("\n-- Menú Importar --")
    print("Ingrese el nombre del archivo a importar (o 'b' para volver):")
    print(">>> ", end="")


def mostrar_menu_exportar():
    print("\n-- Menú Exportar --")
    print("Ingrese el nombre del archivo a exportar (o 'b' para volver):")
    print(">>> ", end="")
